...
// Change static items to database mongoose
...
app.get("/", (req, res) => {
  ...
  // let day = date.getDate(); // using in listTitle
...
// Create express (dynamix) route parameter
